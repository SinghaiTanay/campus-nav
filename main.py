...
building.add_node("Kitchen & Dining Junction", pos=(46, 16), label='Kitchen & Dining Junction')
...
building.add_edge("Dining Area", "Kitchen & Dining Junction")
building.add_edge("Front Closet", "Kitchen & Dining Junction")
# building.add_edge("Bedroom 1", "Kitchen & Dining Junction")
building.add_edge("Bedroom 2", "Kitchen & Dining Junction")
building.add_edge("Bedroom 1", "Bedroom 2")
building.add_edge("Bedroom 3", "Bedroom 2")
building.add_edge("Kitchen", "Kitchen & Dining Junction")
